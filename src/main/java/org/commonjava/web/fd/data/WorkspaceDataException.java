...
public class WorkspaceDataException
    extends Exception
{
    ...
    public WorkspaceDataException( final String message, final Throwable cause, final Object... params )
    {
        super( message, cause );
        this.params = params;
    }

    public WorkspaceDataException( final String message, final Object... params )
    {
        super( message );
        this.params = params;
    }
