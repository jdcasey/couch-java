...
@Singleton
public class ShiroUserManagerConfigurationFactory
    extends DefaultConfigurationListener
{

    private static final String CONFIG_PATH = "/etc/user-manager/user-manager.conf";

    private ShiroUserManagerConfig userManagerConfig;

    public ShiroUserManagerConfigurationFactory()
        throws ConfigurationException
    {
        super( ShiroUserManagerConfig.class );
    }
    ...
    public void configurationComplete()
        throws ConfigurationException
    {
        userManagerConfig = getConfiguration( ShiroUserManagerConfig.class );
    }
