 ...
 This will deploy two artifacts, target/file-depot.war and
 default-ds.xml.
 ...
 - http://localhost:8080/file-depot/
 ...
 Now you can either deploy the target/file-depot.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/file-depot.war

 To undeploy the application, run:

  ./asadmin undeploy file-depot
