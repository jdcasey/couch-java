...
public class DenormalizationException
    extends Exception
{
    ...
    public DenormalizationException( final String message, final Throwable cause,
                                     final Object... params )
    {
        super( message, cause );
        this.params = params;
    ...
    public DenormalizationException( final String message, final Object... params )
    {
        super( message );
        this.params = params;
    }
